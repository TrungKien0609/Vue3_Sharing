      ...
      <div class="item" v-for="(employee, index) in employees" :key="index">
        ...
        <div class="actions" style="width: 20%;">
          <button class="btn edit-btn"
            @click="openFormToEditEmployee(employee)">
            Edit
          </button>
...
export default Vue.extend({
  ...
  methods: {
    ...
    openFormToEditEmployee(employee: Employee) {
      ...
      this.currentEmployeeEmail = employee.email
      this.currentEmployeeCountry = employee.country
      this.currentEmployeeAge = employee.age
      this.currentEmployeeSalary = employee.salary
    },
