<template>
  <div class="container">
    ...
    <button @click="$emit('saveEmployee')" class="save-btn bg-green-400 text-white px-3 py-2 rounded-md mt-3 hover:bg-green-600">Save</button>
</div>
</template>
<script setup lang="ts">
const props = defineProps<{
  currentInputEmployeeName: string
  currentInputEmployeeEmail: string
  currentInputEmployeeCountry: string
  currentInputEmployeeAge: number
  currentInputEmployeeSalary: number
